    ...
    public class QuestionsController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAllQuestions([FromQuery] QuestionsQueryStringParameters queryStringParameters)
        {
            try
            {
                ...
                //var questions = await _repositoryWrapper.QuestionRepository.GetAllQuestionsAsync("", "", queryStringParameters.Sort, queryStringParameters.PageNumber, queryStringParameters.PageSize);

                var questions = await _repositoryWrapper.QuestionRepository.GetAllQuestionsAsync(queryStringParameters.Question, queryStringParameters.Subject, queryStringParameters.Sort, queryStringParameters.PageNumber, queryStringParameters.PageSize);
                ...
                var result = _mapper.Map<List<Dto.Temp.GetQuestionsDto>>(questions);
                if (userRole == "Student")
                {
        ...
        public async Task<IActionResult> GetQuestionAnswers(Guid questionId)
        {
            try
            {
                ...
                var result = _mapper.Map<Dto.Temp.GetQuestionDto>(question);
        ...
        public async Task<IActionResult> CreateQuestion([FromBody] Dto.Temp.CreateQuestionDto createQuestionDto)
        {
            try
            {
                var userEmail = HttpContext.Items["userEmail"] as string;
        ...
        // [TypeFilter(typeof(AuthorizationFilterAttribute))]
        // [ServiceFilter(typeof(ValidationFilterAttribute))]
        public async Task<IActionResult> UpdateQuestion(Guid questionId, [FromBody] Dto.Temp.UpdateQuestionDto updateQuestionDto)
        {
            try
            {
