...
namespace Api.Services.Meetings
{
    public interface IMeetingService
    {
        ...
        public Task<ResponseDto<MeetingDto>> ScheduleMeetingByLecturerAsync(MeetingDto meetingDto,string userEmail);
        public Task<ResponseDto<object>> UpdateMeetingByLecturerAsync(MeetingDto meetingDto, string userEmail);
        public Task<ResponseDto<object>> DeleteMeetingByLecturerAsync(string userEmail, int meetingId);
